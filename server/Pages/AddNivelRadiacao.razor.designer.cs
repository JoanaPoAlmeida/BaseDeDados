...
{
    public partial class AddNivelRadiacaoComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            nivelradiacao = new Radnet.Models.RadnetBd.NivelRadiacao(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Radnet.Models.RadnetBd.NivelRadiacao args)
        {
            try
            {
                var radnetBdCreateNivelRadiacaoResult = await RadnetBd.CreateNivelRadiacao(nivelradiacao);
                DialogService.Close(nivelradiacao);
            }
            catch (System.Exception radnetBdCreateNivelRadiacaoException)
            {
                NotificationService.Notify(new NotificationMessage(){ Severity = NotificationSeverity.Error,Summary = $"Error",Detail = $"Unable to create new NivelRadiacao!" });
            }
        }
